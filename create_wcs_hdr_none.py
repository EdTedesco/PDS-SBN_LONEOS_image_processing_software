...
# prior to 2000-02-04.
# 
# This code creates YYMMDDa_nnn_wcs.hdr files in the ...wd/none/wcs_hdr
# directory, for use by create_label_none.py.
# 
# Input:  Augmented YYMMDDa_nnn.fits files output by add_wcs_none.py and, in
#         D:\LONEOS\wd\none, org_fits_files.txt 
# Output: YYMMDDa_nnn_wcs.hdr header files in D:\LONEOS\wd\none\wcs_hdr.
#
import os
import time
...
f = open('/mnt/d/LONEOS/wd/none/org_fits_files.txt', 'r')
Lines = f.readlines()
count = 0
f.close()
#
...
#pause=input('From create_wcs_hdr_none.py, line 87: Press any key to continue.')
#
...
#    print('fits_files_array[',i,'] =',fits_files_array[i])
    ...
    fits_file_date = in_fits[0:6].strip() # Example 051113_
    exp_num = in_fits[7:10]               # Example 011
    hdr_name = fits_file_date+"a_"+exp_num+"_wcs.hdr"
    dir_path_hdr_name = "/mnt/d/LONEOS/wd/none/wcs_hdr/"+hdr_name
    #print(fits_file_date,exp_num,hdr_name,dir_path_hdr_name)
    #pause = input('From create_wcs_hdr_none.py, line 101: Press any key to continue.')
    in_fits = fits_file_date+"a_"+exp_num+".fits"
#    print('in_fits =',in_fits)
    rtn1 = mGetHdr(in_fits, dir_path_hdr_name)
    #print('in_fits =',in_fits,'rtn1 =',rtn1)
    #pause = input('From create_hdr_none_ds_none.py, line 106. Press any key to continue.')
#    print(fits_file_date,exp_num,dir_path_hdr_name)             # Added _ds
...
# print ('Time for create_wcs_hdr_none.py to process',count,'images was', \
# execution_time, 'seconds', rate, '(images/sec)', )
# print(' ')
print ('From create_wcs_hdr_none.py Line 124: Exiting create_wcs_hdr_none.py')
